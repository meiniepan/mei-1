...
public class SearchViewUtils {
    ...
    public static void autoOpenOrClose(final Context context, final View search, final EditText editText) {
        //隐藏
    ...
    public static void open(final Context context, final View search, final EditText editText) {
    ...
    public static void close(final Context context, final View search, final EditText editText) {
        if (search.getVisibility() == View.VISIBLE) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
