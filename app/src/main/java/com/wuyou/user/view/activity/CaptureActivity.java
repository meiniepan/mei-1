...
import com.wuyou.user.util.zxing.decoding.InactivityTimer;
import com.wuyou.user.util.zxing.decoding.RGBLuminanceSource;
import com.wuyou.user.util.zxing.decoding.Utils;
import com.wuyou.user.util.zxing.view.ViewfinderView;
