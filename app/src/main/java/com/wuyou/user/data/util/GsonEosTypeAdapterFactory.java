package com.wuyou.user.data.util;
...
import com.wuyou.user.data.remote.model.types.TypeAccountName;
import com.wuyou.user.data.remote.model.types.TypeActionName;
import com.wuyou.user.data.remote.model.types.TypeAsset;
import com.wuyou.user.data.remote.model.types.TypeName;
import com.wuyou.user.data.remote.model.types.TypePermissionName;
import com.wuyou.user.data.remote.model.types.TypeScopeName;
